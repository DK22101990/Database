...
namespace CFS.Model.Constants
{
    ...
    public static class StoreProcedure
    {
        ...
        public const string UpdateAccountManagerMap = "sp_UpdateAccountManagerMap {0},{1},{2},{3},{4},'{5}','{6}'";
        public const string DeleteProjectAllocation = "sp_DeleteProjectAllocation {0}";
        public const string DeleteAccountManagerMap = "sp_DeleteAccountManagerMap {0},{1},{2},{3}";
